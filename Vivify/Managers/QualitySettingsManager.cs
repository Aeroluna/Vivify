...
namespace Vivify.Managers
{
    internal class QualitySettingsManager : IInitializable, IDisposable
    {
        ...
        {
            { "_anisotropicFiltering", new QualityEnumCapturedSetting<AnisotropicFiltering>(nameof(QualitySettings.anisotropicFiltering)) },
            ...
            { "_realtimeReflectionProbes", new QualityBoolCapturedSetting(nameof(QualitySettings.realtimeReflectionProbes)) },
            ...
            { "_shadowProjection", new QualityEnumCapturedSetting<ShadowProjection>(nameof(QualitySettings.shadowProjection)) },
            { "_shadowResolution", new QualityEnumCapturedSetting<ShadowResolution>(nameof(QualitySettings.shadowResolution)) },
