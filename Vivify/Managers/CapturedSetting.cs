...
namespace Vivify.Managers
{
        ...
        where TClass : class
    {
        ...
        private static bool Convert(object obj) => (bool)obj;
    }
        ...
        where TProperty : struct
    {
        ...
        public void Capture() => _get();

        public void Reset() => _set(_captured);

        public void Set(object value) => _set(_convert(value));
    }
}
