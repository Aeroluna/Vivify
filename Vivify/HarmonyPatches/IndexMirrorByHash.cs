...
{
    private static readonly MethodInfo _fieldOfViewGetter =
        AccessTools.PropertyGetter(typeof(Camera), nameof(Camera.fieldOfView));

    private static readonly MethodInfo _getFloatHash = AccessTools.Method(
        typeof(IndexMirrorByHash),
        nameof(GetFloatHash));
